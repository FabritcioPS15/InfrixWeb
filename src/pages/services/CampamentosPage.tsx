...
export default function CampamentosPage() {
  const details = [
    'Módulos habitacionales prefabricados',
    'Infraestructura para minería y energía',
    'Soluciones sanitarias modulares',
    'Comedores y áreas comunes eficientes',
    'Montaje rápido y seguro en campo',
  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-white pb-32">
        <PageBanner 
          title="Campamentos Mineros" 
          breadcrumbs={[
            { label: 'Inicio', href: '/' },
            { label: 'Servicios', href: '/servicios' },
            { label: 'Campamentos', href: '/servicios/campamentos-mineros-industriales' }
          ]}
        />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="pt-24 mb-20">
            ...
            <p className="text-gray-400 text-2xl md:text-3xl font-light max-w-4xl leading-snug">
              Infraestructura modular para <span className="text-[#003B5C] font-semibold italic">entornos exigentes</span> con soluciones de habitabilidad de alta eficiencia operativa.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-20 items-center mb-32">
            <div className="order-2 md:order-1">
              <h3 className="text-3xl font-black text-[#003B5C] mb-8 uppercase tracking-tight leading-tight">
                Logística y Montaje Especializado
              </h3>
              <p className="text-gray-500 text-lg mb-10 leading-relaxed">
                Desarrollamos campamentos completos que garantizan la seguridad y el bienestar del personal en ubicaciones remotas. Nuestros módulos están diseñados para resistir condiciones climáticas adversas.
              </p>
              ...
              <Link
                to="/contacto?service=campamentos-mineros-industriales"
            ...
            <div className="order-1 md:order-2">
              <div className="aspect-square bg-gray-100 overflow-hidden shadow-2xl relative group">
                <img 
                  src="https://images.pexels.com/photos/256297/pexels-photo-256297.jpeg?auto=compress&cs=tinysrgb&w=1200" 
                  alt="Campamentos Mineros" 
