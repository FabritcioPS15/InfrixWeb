...
export default function ElectricasPage() {
  const details = [
    'Diseño eléctrico profesional',
    'Instalaciones residenciales',
    'Sistemas comerciales e industriales',
    'Automatización inteligente',
    'Paneles y protecciones',
    'Normativa NEC cumplida',
  ];
      ...
      <div className="min-h-screen bg-white pb-32">
        <PageBanner 
          ...
          breadcrumbs={[
            ...
            { label: 'Eléctricas', href: '/servicios/instalaciones-electricas' }
          ]}
        />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="pt-24 mb-20">
            ...
            <p className="text-gray-400 text-2xl md:text-3xl font-light max-w-4xl leading-snug">
              Infraestructura <span className="text-[#003B5C] font-semibold italic">eléctrica segura</span> con estándares técnicos internacionales y eficiencia garantizada.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-20 items-center mb-32">
            <div className="order-2 md:order-1">
              ...
              <p className="text-gray-500 text-lg mb-10 leading-relaxed">
                Implementamos soluciones eléctricas de media y baja tensión para entornos residenciales, comerciales e industriales bajo estrictas normativas de seguridad.
              </p>
              ...
              <Link
                to="/contacto?service=instalaciones-electricas"
