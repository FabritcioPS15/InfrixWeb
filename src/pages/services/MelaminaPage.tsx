...
export default function MelaminaPage() {
  const details = [
    ...
    'Acabados premium y variados',
    'Closets y espacios organizados',
    'Muebles de cocina a medida',
    'Instalación experta certificada',
  ];
      ...
      <div className="min-h-screen bg-white pb-32">
        <PageBanner 
          ...
          breadcrumbs={[
            ...
            { label: 'Melamina', href: '/servicios/melamina-muebles' }
          ]}
        />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="pt-24 mb-20">
            ...
            <p className="text-gray-400 text-2xl md:text-3xl font-light max-w-4xl leading-snug">
              Diseño y fabricación de <span className="text-[#003B5C] font-semibold italic">mobiliario funcional</span> con acabados de alta gama y materiales de primera.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-20 items-center mb-32">
            <div className="order-2 md:order-1">
              <h3 className="text-3xl font-black text-[#003B5C] mb-8 uppercase tracking-tight leading-tight">
                Muebles a Medida de Alta Calidad
              </h3>
              <p className="text-gray-500 text-lg mb-10 leading-relaxed">
                Transformamos tus espacios con piezas únicas diseñadas bajo tus requerimientos específicos. Utilizamos melamina de alta resistencia y herrajes de última generación.
              </p>
              ...
              <Link
                to="/contacto?service=melamina-muebles"
            ...
            <div className="order-1 md:order-2">
              <div className="aspect-square bg-gray-100 overflow-hidden shadow-2xl relative group">
                <img 
                  src="https://images.pexels.com/photos/209315/pexels-photo-209315.jpeg?auto=compress&cs=tinysrgb&w=1200" 
                  alt="Melamina y Muebles" 
