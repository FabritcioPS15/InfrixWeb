...
export default function CivilesPage() {
  const details = [
    'Diseño y cálculo estructural',
    'Excavaciones y fundaciones',
    'Construcción de estructuras de concreto',
    'Sistemas electromecánicos integrados',
      ...
      <div className="min-h-screen bg-white pb-32">
        <PageBanner 
          ...
          breadcrumbs={[
            ...
            { label: 'Obras Civiles', href: '/servicios/proyectos-civiles-electromecanicos' }
          ]}
        />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="pt-24 mb-20">
            ...
            <p className="text-gray-400 text-2xl md:text-3xl font-light max-w-4xl leading-snug">
              Infraestructura de <span className="text-[#003B5C] font-semibold italic">gran envergadura</span> con ingeniería especializada y estándares de ejecución superiores.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-20 items-center mb-32">
            <div className="order-2 md:order-1">
              <h3 className="text-3xl font-black text-[#003B5C] mb-8 uppercase tracking-tight leading-tight">
                Construcción e Ingeniería de Detalle
              </h3>
              <p className="text-gray-500 text-lg mb-10 leading-relaxed">
                Desarrollamos proyectos complejos integrando obra civil y sistemas electromecánicos. Nuestra capacidad técnica asegura la solidez estructural y operativa de cada instalación.
              </p>
              ...
              <Link
                to="/contacto?service=proyectos-civiles-electromecanicos"
